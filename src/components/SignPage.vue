<template>
  <div class="hello" :style="{height: wh+'px'}">
    ...
    <van-button
      ...
      color="#d7000f"
      type="primary"
      :class="'animate__animated animate__' + animate.button_second"
      @click="switchRoute(2)"
    >登录</van-button>
  </div>
</template>
